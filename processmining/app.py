...
from p2ptransformer import transformer_router
from o2ctransformer import o2c_transformer_router
from p2i4 import router as p2i_router
from p2itransformer import p2i_transformer_router

app = FastAPI(title="Process Mining Dynamic API (O2C, P2P & P2I)")
...
print("[INFO] Modules: O2C, P2P, P2I, P2P-Transformer, O2C-Transformer, P2I-Transformer")
...
app.include_router(transformer_router)        # ← P2P-Transformer
app.include_router(o2c_transformer_router)    # ← O2C-Transformer
app.include_router(p2i_router)                # ← P2I Analytics
...
def root():
    return {
        ...
        "modules_available": [
            "/o2c", "/p2p", "/p2i",
            "/p2p/transform", "/o2c/transform", "/p2i/transform"
        ]
    }
