              ...
              <motion.div layout style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                ...
                <AnimatePresence>
                  {hoveredSide !== 'csv' && (
                    ...
                    >
                      Connect directly to your ERP databases and query tables such as <strong>FIN_REQUESTS</strong>, <strong>FIN_ALLOCATIONS</strong>, and <strong>FIN_COMMITTEES</strong> automatically.
                    </motion.p>
                  )}
                </AnimatePresence>
              </motion.div>
                ...
                <AnimatePresence>
                  {hoveredSide !== 'build' && (
                    <motion.p
                      ...
                      style={{ fontSize: '12.5px', color: '#605E5C', lineHeight: '1.5', margin: 0 }}
                    >
                      Import budget request event logs from your financial software. Map CSV headers for Case ID, Activity, and Timestamp in real-time.
                    </motion.p>
                  )}
                </AnimatePresence>
              </motion.div>
        ...
        <div style={{ flex: 1, overflowY: 'auto', padding: '12px 14px 40px', display: 'flex', flexDirection: 'column', gap: 10 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: 10 }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10, height: 600 }}>
              <ChartCard title="Budget request status" style={{ flex: 1 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10 }}>
            ...
            <ChartCard title="Budget Cases List & Checklist">
              {selectedCaseId === 'ALL' ? (
