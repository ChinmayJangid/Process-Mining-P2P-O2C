              ...
              <motion.div layout style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                ...
                <AnimatePresence>
                  {hoveredSide !== 'csv' && (
                    ...
                    >
                      Connect directly to your SAP ledger database. Query and consolidate transaction tables such as <strong>BKPF</strong> and <strong>BSEG</strong> automatically.
                    </motion.p>
                  )}
                </AnimatePresence>
              </motion.div>
                ...
                <AnimatePresence>
                  {hoveredSide !== 'build' && (
                    <motion.p
                      ...
                      style={{ fontSize: '12.5px', color: '#605E5C', lineHeight: '1.5', margin: 0 }}
                    >
                      Import a standardized CSV/XLSX file. Map your custom schema headers (Case ID, Activity, Timestamp) in real-time.
                    </motion.p>
                  )}
                </AnimatePresence>
              </motion.div>
        ...
        <div style={{ flex: 1, overflowY: 'auto', padding: '12px 14px 40px', display: 'flex', flexDirection: 'column', gap: 10 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: 10 }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10, height: 600 }}>
              <ChartCard title="Happy Path vs Deviations" style={{ flex: 1 }}>
              ...
              <ChartCard title="Activity Frequency" style={{ flex: 1.2 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10 }}>
            <ChartCard title="Monthly Posting Volume">
            ...
            <ChartCard title="Case Details & Drill-down">
              {selectedCaseId === 'ALL' ? (
